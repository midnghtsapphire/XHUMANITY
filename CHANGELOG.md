...
- Clarified that Website-in-Test hosting is Vercel-only (no Netlify/Netfly) for database-integrated test flows.

## [0.1.0] - 2026-05-21

### Added

- Initial revvel-standards documentation baseline.
- Initial mission definition and standards alignment.
- Deployment, go-to-market, brand, and security documentation.
